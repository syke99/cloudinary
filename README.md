...
// you want your image to be saved as in your cloud account (no file extension needed) if you're going
// to upload an asset or the name of the asset that's already uploaded
